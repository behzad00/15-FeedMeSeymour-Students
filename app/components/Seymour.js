...
class Seymour extends React.Component {
    constructor(props) {
        super(props);
        // Here we set a generic state associated with the number of consumed entities
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        <Child1 feedSeymour={this.feedSeymour.bind(this)}/>
                    ...
                    <div className="col-md-4">
                        ...
                        <Child2 feedSeymour={this.feedSeymour.bind(this)}/>
                    ...
                    <div className="col-md-4">
                        ...
                        <Child3 feedSeymour={this.feedSeymour.bind(this)}/>
